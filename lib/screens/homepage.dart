              ...
              children: <Widget>[
                ...
                SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        propCard(
                            'icons/Bear.svg', 'Большой медведь', 5500, 6000, 5),
                        propCard('icons/Croco.svg', 'Смешной крокодил', 1250,
                            2000, 12),
                        propCard(
                            'icons/Cat.svg', 'Плюшевый кот', 3000, 3250, 7),
                        propCard('icons/Ball.svg', 'Мягкий мяч', 800, 900, 18)
                      ],
                    )),
                Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                            ...
                            child: Text('Большой медведь ${index + 1}',
                                style: TextStyle(
