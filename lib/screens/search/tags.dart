                ...
                children: [
                  InkWell(
                    ...
                    onTap: () async {
                      ...
                      List<Map<String, dynamic>> sortedProducts = await SQLHelper.sortByTag('Большие');
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      context.goNamed('Search');
                      List<Map<String, dynamic>> sortedProducts = await SQLHelper.sortByTag('Круглые');
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      context.goNamed('Search');
                      List<Map<String, dynamic>> sortedProducts = await SQLHelper.sortByTag('Объёмные');
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      context.goNamed('Search');
                      List<Map<String, dynamic>> sortedProducts = await SQLHelper.sortByTag('Маленькие');
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      context.goNamed('Search');
                      List<Map<String, dynamic>> sortedProducts = await SQLHelper.sortByTag('Смешные');
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      context.goNamed('Search');
                      List<Map<String, dynamic>> sortedProducts = await SQLHelper.sortByTag('Сезонные');
